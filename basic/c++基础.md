...
编译器首先会找全局的operator+，然后找double的转换函数
...
**禁用**编译器自动调用*non-explicit-one-argument ctor*
大部分情况下用在构造函数前
...
void* next;
T data;
};template<class t,="" class="" ref,="" ptr="">
